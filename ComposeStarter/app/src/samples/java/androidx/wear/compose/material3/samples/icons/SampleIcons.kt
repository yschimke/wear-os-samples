...
fun AvatarIcon() {
    Icon(
        painter = painterResource(AppR.drawable.ic_account_circle),
...
fun CheckIcon(modifier: Modifier = Modifier.size(ButtonDefaults.IconSize)) {
    Icon(
        painter = painterResource(AppR.drawable.ic_check_rounded),
...
fun WifiOnIcon(modifier: Modifier = Modifier) {
    Icon(
        painter = painterResource(AppR.drawable.ic_wifi_on),
...
fun WifiOffIcon(modifier: Modifier = Modifier) {
    Icon(
        painter = painterResource(AppR.drawable.ic_wifi_off),
...
fun HeadphoneIcon(size: Dp) {
    Icon(
        painter = painterResource(AppR.drawable.ic_headphones),
...
fun VolumeUpIcon(size: Dp) {
    Icon(
        painter = painterResource(AppR.drawable.ic_volume_up),
...
fun VolumeDownIcon(size: Dp) {
    Icon(
        painter = painterResource(AppR.drawable.ic_volume_down),
