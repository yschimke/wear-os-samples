...
SOURCE_SUBDIR="wear/compose/remote/remote-material3/samples/src/main"
DEST_DIR="app/src/samples"
PATCH_DIR="patches/remote-material3-samples"
...
echo "Imported remote material3 samples into ${DEST_DIR}"
