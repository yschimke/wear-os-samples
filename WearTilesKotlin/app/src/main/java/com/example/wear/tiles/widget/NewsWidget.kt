...
fun NewsWidget() {
    WidgetContainer {
        RemoteColumn(horizontalAlignment = RemoteAlignment.CenterHorizontally) {
            ...
            RemoteText(
                text = "Millions still without power as new storm moves across US".rs,
...
@Composable
fun NewsWidgetPreview() = RemotePreview(profile = RcPlatformProfiles.ANDROIDX) { NewsWidget() }
